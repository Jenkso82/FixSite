    ...
    <style>
        * {
        ...
        .form input:focus {
            ...
            border-color: #8d99ae;
            background: #fff;
            box-shadow: 0 4px 12px rgba(141, 153, 174, 0.1);
        }
        ...
        body.dark-theme .switch-form-text {
            color: #bbbbbb;
        }

        body.dark-theme .switch-form-text a {
            color: #ffffff;
        }

        body.dark-theme .switch-form-text a:hover {
            color: #e0e0e0;
        }
        ...
        body.dark-theme .more-options:hover {
            color: #e0e0e0;
        }

        body.dark-theme .accept-button {
            background: #ffffff;
            color: #121212;
        }

        body.dark-theme .accept-button:hover {
            background: #e0e0e0;
            color: #121212;
        }
...
<body>
    <button class="theme-switcher" id="theme-switcher">Темная тема</button>
    <div class="container">
        <form id="login-form" class="form active">
            <h2>Вход в аккаунт</h2>
            <div>
                <input type="text" placeholder="Логин или Эл. почта" id="login-identifier">
                <div class="tooltip error" id="login-identifier-error"></div>
            </div>
            <div class="password-container">
                <input type="password" placeholder="Пароль" id="login-password">
                <div class="eye-icon">
                    <img src="https://i.postimg.cc/YCTCmH6G/eye.png" border="0" alt="eye" class="eye-open" style="display: block;">
                    <img src="https://i.postimg.cc/C1shtnWk/hidden.png" border="0" alt="hidden" class="eye-closed" style="display: none;">
                </div>
        ...
        <form id="register-form" class="form">
            ...
            <input type="text" placeholder="Логин"_VALUES:1-30"></input>
            <div class="tooltip error" id="register-username-error"></div>
            <input type="email" placeholder="Эл. почта" id="register-email">
